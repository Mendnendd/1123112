...
('AI Momentum', 'AI-driven momentum trading strategy using RSI and MACD', 'DAY_TRADING', 'BOTH', 0.75),
('Mean Reversion', 'Mean reversion strategy using Bollinger Bands and support/resistance', 'SWING', 'BOTH', 0.70),
('Trend Following', 'Long-term trend following strategy with moving averages', 'POSITION', 'BOTH', 0.80),
('Scalping Pro', 'High-frequency scalping strategy for quick profits', 'SCALPING', 'FUTURES', 0.85);
